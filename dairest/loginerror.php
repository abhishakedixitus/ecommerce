...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    ...
    <div class="error">
		<a>
		  <img src= "img/error/2.png" alt= "sad mumu face" class="sad">
		</a>
        <center><h3> Sorry!!! Username or password doesn't exist.</h3></center><br><br><br>
        <div class="products"> <center><h1><a href="sign-in.php" style="text-decoration:underline"">Click here to Sign In again </a></h1></center></div>
    </div><br><br>
    <!-- error-area-end -->
...
if (screen.width <= 699) {
location.assign("m_loginerror.php")
}
