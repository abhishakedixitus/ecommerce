			...
			<div class="container">
				<div class="row">
					...
					include 'connection.php';
						...
						$sql = " SELECT * FROM products where p_type LIKE 'chocolate'";
						if (!$conn) {
						die("Connection failed: " . mysqli_connect_error());
						}
								...
								<div class="col-lg-12">
									<div class="single-new-product">
                                        ...
                                        <div class="product-img">
											<a title="Sign-in to store products in cart!"  href="single.php?p='.$row["p_id"].'">
												<img src="'.$row["p_image"].'" alt="" class="img-responsive" class="first_img" alt="" style="width:400px;height:300px" />
											</a>
										</div>

										<div class="product-content text-center">
											<a title="Sign-in to store products in cart!"  href="single.php?p='.$row["p_id"].'"><h3>'.$row["p_name"].'</h3></a>
...
if (screen.width <= 699) {
location.assign("m_chocolate.php")
}
