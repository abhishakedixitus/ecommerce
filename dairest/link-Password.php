...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="logo logo2">
								<a href="index.html"><img src="img/logo/logo2.png" width="300px" height="100px" alt="" /></a>
							</div>
						</div>
							...
							<div class="header-bottom-right header-bottom-right-4">
								<div class="shop-cart shop-cart-empty">
									<a title="Sign-in to store products in cart!" href="#" style="color:#ffffff"><span class="lnr lnr-cart"></span></a>
								</div>
							</div>	
						</div>
					</div>
    ...
    <br>
          <center> <h3 style="font-size: 145%">Kindly check email and click on the link to reset Password.</h3></center><br><br><br>
...
if (screen.width <= 699) {
location.replace("mobile-linkPassword.php")
}
