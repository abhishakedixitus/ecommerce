...
<?php
	...
	if (isset($_POST['fullname']) && isset($_POST['userid']) && isset($_POST['address']) && isset($_POST['pincode']) && isset($_POST['city']) && isset($_POST['state']) && isset($_POST['mobile']))
	{
        ...
        $sql = 	"select o_id from orders where o_id = max(o_id) and o_u_id = $o_u_id";
        $result = mysqli_query($conn,$sql) or mysqli_error($conn);

		$sql = 	"Insert into orderhistory (o_id, c_u_id, c_p_id, c_name, c_price) values  ('$o_u_id','$name','$add','$pin','$citi','$stat','$mob')";
        $result = mysqli_query($conn,$sql) or mysqli_error($conn);
        ...
        echo '<a><center>
		  <img src= "img/logo/jump.png" alt= "" class="happy"></center>
				...
				echo '<br><br><h1><center>Go Back To Category-> <a href="u_chocolate.php">Chocolate</a> / <a href="u_lollipop.php">Lollipop</a> / <a href="u_cake.php">Cake</a>  </center></h1>';
        echo '<br><br><h1><center><a href="cart.php">Go To Cart</a></center></h1><br><br>';
	}
?>
<!--//storing complete-->
...
if (screen.width <= 699) {
location.assign("m_order_confirm.php")
}
