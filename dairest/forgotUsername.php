...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    ...
    <div class="x0" style="width:1300px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
          ...
          <form action="link-Username.php" method="post" style="width:410px;height:250px; padding:13px">
              
        <h3 style="font-size: 130%; text-align:center">Get your registered Username </h3><br><br>
...
if (screen.width <= 699) {
location.assign("m_forgotUsername.php")
}
