 ...
 <!-- sign-in-area-start -->
   ...
   <div class="x0" style="width:90%; margin-top:0.1%; padding:0.1%">
      <div class="x2" style="width:70%; margin-left:20%;margin-right:10%">
        ...
        <h4 style="font-size: 50%vw; text-align:center">Sorry!! Registered Email Id or Mobile no. is required to get username or set up new password. </h4><br>
      <h4 style="font-size: 15%vw">You may contact our customer service on 989-657-4321 for further help or sign up again. </h4><br><br><br>
          <center><h2><a href="sign-up.php" style="text-decoration:underline">Click here to Sign Up again!</a></h2></center>
        </div>
...
if (screen.width > 699) {
location.replace("forgotMobile.php")
}
