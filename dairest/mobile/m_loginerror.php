...
<!-- mainmenu-area-start -->
  ...
  <!-- error-area-start -->
    <div class="error">
        ...
        <center><h4> Sorry!!! Username or password doesn't exist.</h4></center><br><br><br>
        <div class="products"> <center><h3><a href="sign-in.php style="text-decoration:underline"">Click here to Sign In again </a></h3></center></div>
    </div><br><br>
    <!-- error-area-end -->
...
if (screen.width > 699) {
location.replace("loginerror.php")
}
