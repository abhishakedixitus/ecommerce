...
<html class="no-js" lang="en">
    ...
    <!--new-product-area-start -->
		<div class="new-product-area hot-deal-area dotted-5 new-product-4 pt-80" style= "width:100%; margin-top:5%;margin-left:10% padding:20%">
			<div class="container">
				<div class="row">
									...
									<div class="single-new-product">
										...
										<div class="product-img">
											<a href="product-details.php">
												<img src="img/product/1.jpg" class="first_img" alt="" style="width:400px;height:200px"/>
											</a>
										</div>
<br>
										<div class="product-content text-center">
											<a href="product-details.php" ><h4>Classic French Macarons</h4></a>
											...
											<div class="price" >
												<h4>$ 34.99</h4>
												<h4 class="del-price" ><del>$ 45</del></h4>
											</div>
										</div>
								...
								<div class="col-lg-12">
									<div class="single-new-product">
										...
										<div class="product-img">
											<a href="product-details.php">
												<img src="img/product/2.jpg" class="first_img" alt="" style="width:400px;height:200px"/>

											</a>
										</div>
<br>
										<div class="product-content text-center">
											<a href="product-details.php"><h4>Mooncake Mid-Autumn Festival</h4></a>
											<div class="product-price-star">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
								...
								<div class="col-lg-12">
									<div class="single-new-product">
										<div class="product-img">
											<a href="product-details.php">
												<img src="img/product/3.jpg" class="first_img" alt="" style="width:400px;height:200px"/>
											</a>
										</div>
										<div class="product-content text-center">
											<a href="product-details.php"><h4>Janpanese Mochi Cream</h4></a>
											<div class="product-price-star">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
								...
								<div class="col-lg-12">
									<div class="single-new-product">
										<div class="product-img">
											<a href="product-details.php">
												<img src="img/product/4.jpg" class="first_img" alt="" style="width:400px;height:200px"/>
											</a>
										</div>
<br>
										<div class="product-content text-center">
											<a href="product-details.php"><h4>Hershey's Special Dark Chocolate Miniatures Bars 3lb bag</h4></a>
											<div class="product-price-star">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
                      ...
                      <div class="price">
												<h4>$ 30</h4>
												<h4 class="del-price"><del>$ 35.94</del></h4>
											</div>
										</div>
								...
								<div class="col-lg-12">
									<div class="single-new-product">
										<div class="product-img">
											<a href="product-details.php">
												<img src="img/product/5.jpg" class="first_img" alt="" style="width:400px;height:200px"/>
											</a>
										</div>
                                        <br>
										<div class="product-content text-center">
											<a href="product-details.php"><h4>Lollipop Marshmallow</h4></a>
											<div class="product-price-star">
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
												<i class="fa fa-star"></i>
											...
											<div class="price">
												<h4>$ 15.99</h4>
												<h4 class="del-price"><del>$ 9.99</del></h4>
											</div>
										</div>
							...
							<div class="col-lg-12">
								<div class="single-static-banner">
									<div class="single-static-img">
										<a href="index.php"><img src="img/banner/ads-middle-grand4.jpg" alt="" style="width:1200px;height:400px;opacity=1;filter: alpha(opacity=100)"/></a>
										<div class="single-static-text single-static-text-4">
											<h2>Up to <strong>50% OFF</strong></h2>
                      <br>
                      <br>
