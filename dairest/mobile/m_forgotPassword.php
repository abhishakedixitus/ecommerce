...
<!-- mainmenu-area-start -->
  ...
  <div class="x0" style="width:90%; margin-top:0.1%; padding:0.1%">
      <div class="x2" style="width:70%; margin-left:20%;margin-right:10%">
          ...
          <form action="link-Password.php" method="post" >
              
        <h3 style="font-size: 50%vw; text-align:center">Get link to reset Password</h3><br><br>
      <h4 style="font-size: 15%vw">Registered Email Id:</h4>
          <input type="email" id="mail" name="user_email" style="border-color:rgb(110,65,30);border-width:thin" size=30vw required><br>
