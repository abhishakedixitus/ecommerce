                        ...
                        <div class="col-md-5 grid-single">
                            <div class="flexslider">
                                <ul class="slides">
									...
									<br><br>	<h2 class="quick">Description:</h2>
										<p class="quick_desc">'.$row['p_description'].'</p>
											...
											<div class="quick-add-to-cart">
												...
												<a class="item_add" href="addcart.php?mycart='.$row['p_id'].'&userid='.$id.'"><img height="42" width="100" src="img/cart/cartaddbutn.png"></img> </a>	
