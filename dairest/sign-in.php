...
<html class="no-js" lang="en">
    ...
    <div class="x0" style="width:1300px; margin-top:0.000001px; padding:0.00001px">
      <div class="x2" style="width:700px; margin-left:200px;margin-right:100px">
        ...
        <h1 style="font-size: 50%vw; text-align:center">Sign In</h1><br>
        <h4 style="font-size: 15%vw">Username:</h4>
          
          
		    <input type="text" id="name"  name="user_name" style="border-color:rgb(110,65,30);border-width:thin" size="30" required >
              <p> <a href= "forgotUsername.php" style="color:blue;margin-top:5%; font-size: 0.9vw;text-decoration: underline">Forgot Username?</a></p>
     <h4 style="font-size: 15%vw">Password:</h4>
		    <input type="password" id="passw" name="user_password" style="border-color:rgb(110,65,30);border-width:thin" size="30" required ><br>
          
          <p> <a href= "forgotPassword.php" style="color:blue;margin-top:5%; font-size: 0.9vw;text-decoration: underline">Forgot Password?</a></p>
